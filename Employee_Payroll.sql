...
-- THIS WILL CREATE COLUMN WITH DEFAULT VALUE 
ALTER TABLE Employee_Payroll ADD TEST INT NOT NULL DEFAULT('') 
ALTER TABLE Employee_Payroll ADD TEST1 VARCHAR(10) NOT NULL DEFAULT('') 

ALTER TABLE Employee_Payroll DROP COLUMN TEST1
